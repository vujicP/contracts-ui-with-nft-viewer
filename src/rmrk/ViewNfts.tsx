    ...
    <div className="grid grid-cols-12 gap-4 w-full">
      {nfts.map(nft => (
        <div className="col-span-3">
          <div className="w-80 border text-gray-500 dark:border-gray-700 border-gray-200 rounded-xl dark:bg-elevation-1 dark:hover:bg-elevation-2 hover:bg-gray-100 cursor-pointer">
            ...
            <div className="border-t -md pl-4 pt-4 pb-4 text-gray-500 dark:border-gray-700 border-gray-200 items-center text-base dark:text-gray-300 text-gray-500">
              ...
              <div class="mt-2 italic">{nft?.collection.description}</div>
            </div>
          </div>
        </div>
      ))}
